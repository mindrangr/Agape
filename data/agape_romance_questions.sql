...
--
-- Database: `agape_romance_questions`
--
CREATE DATABASE IF NOT EXISTS `agape_romance_questions` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `agape_romance_questions`;

-- --------------------------------------------------------

--
-- Table structure for table `agape_romance_answers`
--

CREATE TABLE IF NOT EXISTS `agape_romance_answers` (
...
--
-- Dumping data for table `agape_romance_answers`
--

INSERT INTO `agape_romance_answers` (`agape_answers_ID`, `agape_answers_Question_ID`, `agape_answers_answer`, `agape_answers_gender`, `agape_answers_age`, `agape_answers_religion`, `agape_answers_city`, `agape_answers_state`, `agape_answers_race`, `agape_answers_income`, `agape_answers_politics`, `agape_answers_education`, `agape_answers_nation`, `agape_answers_created`) VALUES
...
--
-- Table structure for table `agape_romance_questions`
--

CREATE TABLE IF NOT EXISTS `agape_romance_questions` (
...
--
-- Dumping data for table `agape_romance_questions`
--

INSERT INTO `agape_romance_questions` (`question_ID`, `question_Core`, `question_reply`, `question_group`, `question_type`) VALUES
(1, 'So whose it going to be in 2016? Take a dip in our April popularity vote.', '{"answers":[{"param1":"Marco Rubio","count":14},{"param1":"Mike Huckabee","count":8},{"param1":"Ben Carson","count":9},{"param1":"John Kasich","count":12},{"param1":"Martin O&#39;Malley","count":3},{"param1":"Rick Santorum","count":11},{"param1":"Donald Trump","count":6},{"param1":"Bernie Sanders","count":7},{"param1":"Carly Fiorina","count":11},{"param1":"Rick Santorum","count":11},{"param1":"Hillary Clinton","count":10},{"param1":"Ted Cruz","count":7},{"param1":"Jeb Bush","count":8},{"param1":"Rand Paul","count":7},{"param1":"Chris Christie","count":6}]}', 'Romance', '{"type":"radio","qnty":1}'),
(2, 'Should ISIS be the primary issue for all of the candidate?', '{"answers":[{"param1":"Yes","count":127},{"param1":"No","count":647},{"param1":"Not at this time.","count":99}]}', 'Romance', '{"type":"radio","qnty":1}'),
(3, 'How do you feel about interracial dating?', '{"answers":[{"param1":"I&#39;m all for it!","count":13426},{"param1":"To each his own","count":2670},{"param1":"I&#39;m against it.","count":16601}]}', 'Romance', '{"type":"radio","qnty":1}');
