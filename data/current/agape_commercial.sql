...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2017 at 03:54 PM
...
(2, 250, 'Paris LLC', 'Food and Beverage', 'Thomas', 'Hill', '8310 West Coffet ct', 'Miami', 'Florida', '33161', '877-526-8812', '0', '', '', '2017-05-03 01:24:33');
...
--
ALTER TABLE `agape_commercial`
  MODIFY `agape_commercial_Id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
