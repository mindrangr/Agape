 ...
 <html>
	<head>
		...
		function cityFiller(obj,cityElement)
		{
			...
			var sta=$(obj).val();			
			$.get("AjaxPage1.php",{job:'cityFiller',state:sta},function(data){citySelFiller(data,cityElement)})
		}
		...
		function visitPro()
		{
			...
			testwindow = window.open("viewpro.php?par="+looperID, "mywindow", "location=1,status=1,width=790,height=1100,scrollbars=1,status=1");    
		...
		function parseState(obj,ID)
		{
			...
			for(i=0; i<leng; i++){
				...
				if(window.userObj[ID]==newObj[i]['state_name'])
				{				
					myList += "<option selected>"+newObj[i]['state_name']+"</option>";
				}
				else
				{
					myList += "<option>"+newObj[i]['state_name']+"</option>";		
				}
				
			}

			$("#"+ID).append(myList);
			//$("#search_partner_state").append(myList);
					...
					<span style="font-weight:bold;font-size:18px;">Friendship requests</span>
						<div style="padding:8px; border-radius:12px;background-image:url('images/scanBak.jpg');width:600px;">
							...
							<div id="mainDiv" style="height:1400px;position:relative;width:950px">
								<div >
									<span style="font-weight:bold;font-size:16px;color:lime;cursor:pointer;" onmouseover="changeDivColor(this,'out')" onmouseout="changeDivColor(this,'over')" onclick="changeMenu('editViewPro')"><u>Edit</u></span>
								</div>
								<br/>
							...
							<!--<div class="profileDivStyles1">
								...
								<div style="float:left;">
									<select id="agape_profile_state2" class="profileTBox">
						...
						<div  id="proView" style="display:none;float:left;">
						
							<div style="width:700px;border-radius:9px;height:1100px;background-image:url('images/gradient4.jpg');background-repeat:repeat-x;background-color:#2e2e2e;">
								<table cellpadding="7" >
									<tr>
										<td>
											<IMG src="profileImages/male8_b.jpg" height="200" width="155"  style="border:solid 2px lime;" id="hostImg" />
										</td>
										<td valign="top">
										<br/>
											<table valign="top">
												...
												<tr>
													...
													<td><div class="fields_pr" id="agape_profile_salary_pr"></div></td>
												</tr>
												...
												<tr>
													<td colspan="4">
														...
														<div style="display:inline-block;vertical-align:top;">What can you expect from me?</div>
														<div style="display:inline-block;margin-left:183px;"><img src="images/flags/usa.jpg"/></div></div>
													</td>
												...
												<tr>
													<td colspan="4">
														<div id="loveOptions" style="color:lime;font-size:13px;"></div>
													</td>
								...
								<span class="edwardText">How would I describe myself?</span>
								<div class="profile_descripBoxes" id="agape_profile_description_pr">
								</div>
								<BR/>
								<BR/>
								
								<span class="edwardText">What would I consider the ideal first date?</span>
								...
								<span class="edwardText">Here is how I would describe my ideal partner.</span>
										...
										<td valign="top" width="320">
											...
											<table width="300" >
												...
												<tr>										
													...
													<td colspan="2"><input type="button" value="friend request" onclick="fRequest()" /></td>
												</tr>
												
												<tr>
													<td colspan="2"><input type="button" value="visit profile" onclick="visitPro()"/></td>
