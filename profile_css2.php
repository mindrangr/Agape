...
<body bgcolor="black" style="margin:auto;width:950px;text-align:center;font-family:arial;" onload="checkLogin()">
		<form name="form1" >
		<div class="profileStyle1pro" >
			<div style="height:220px;width:940px;text-align:right;padding-right:13px;" id="dashboardWrap">
				
			</div>
			<div style="width:800px;height:1000px;float:left;text-align:left;padding-left:100px">
				<div id="dashboardDiv">				
					...
					<div id="mainDiv" style="height:1400px;position:relative;z-index:1">					
						<div >
							<div style="width:430px;text-align:left;">
								...
								<div style="float:left;"><input id="agape_profile_firstname" type="textbox"  class="profileTBox" onkeydown="changeBack(this)" />
								</div>
								<div style="clear:both"></div>
							</div>
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>Lastname</b>
								<span style="font-size:14px;color:red;font-weight:bold;">*</span></div>
								<div style="float:left;"><input id="agape_profile_lastname" onkeydown="changeBack(this)" type="textbox"  class="profileTBox" /></div>
								<div style="clear:both"></div>
							</div>
						
						
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>Gender</b><span style="font-size:14px;color:red;font-weight:bold;">*</span></div>
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>Username</b><span style="font-size:14px;color:red;font-weight:bold;">*</span></div>
								<div style="float:left;"><input id="agape_profile_username" onkeydown="changeBack(this)" type="textbox"  class="profileTBox" onblur="memUsernchk(this)" /></div>
								<div style="clear:both"></div>
							</div>
						
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>Password</b><span style="font-size:14px;color:red;font-weight:bold;">*</span></div>
								<div style="float:left;"><input id="agape_profile_password" onkeydown="changeBack(this)" type="textbox"  class="profileTBox" /></div>
								<div style="clear:both"></div>
							</div>
						
						
							<div style="width:430px;text-align:left;position:relative;z-index:1">
								<div style="width:230px;float:left;"><b>Date of Birth</b></div>
								<div style="float:left;">
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>Race</b></div>
								<div style="float:left;">
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>Body type</b></div>
								<div style="float:left;">
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>Height</b></div>
								<div style="float:left;"><input id="agape_profile_height" type="textbox"  class="profileTBox" /></div>
								<div style="clear:both"></div>
							</div>
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>City</b><span style="font-size:14px;color:red;font-weight:bold;">*</span></div>
								<div style="float:left;"><input id="agape_profile_city" onkeydown="changeBack(this)" type="textbox"  class="profileTBox" /></div>
								<div style="clear:both"></div>
							</div>
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>State</b></div>
								<div style="float:left;">
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>Email address</b><span style="font-size:14px;color:red;font-weight:bold;">*</span></div>
								<div style="float:left;"><input id="agape_profile_email" onkeydown="changeBack(this)" type="textbox"  class="profileTBox" onblur="memUsernchk(this)"/></div>
								<div style="clear:both"></div>
							</div>
							
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left"><b>Your annual salary</b></div>
								<div>
									<div style="float:left;">
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>Religion</b></div>
								<div style="float:left;">
									<div style="float:left;">
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>Intentions</b></div>
								<div style="float:left;">
									<div style="float:left;">
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left"><b>Do you have children</b></div>
								<div>
									<div style="float:left;">
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left"><b>Highest education completed</b></div>
								<div>
									<div style="float:left;">
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left"><b>Check the options to your right that a romantic partner can expect from you:</b></div>
								<div>
									<div style="float:left;">
									<table>
										<tr>
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left"><b>How often do you drink alcohol?</b></div>
								<div>
									<div style="float:left;">
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left"><b>Do you use drugs?</b></div>
								<div>
									<div style="float:left;">
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left"><b>Briefly talk about yourself</b>
							...
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left"><b>Describe your ideal romantic partner:</b><font size="2">(<i>This is not a laundry list of likes, dislikes, wants and no wants. This should be a description of where he/she should be in life and what they should understand and expect from you. A person intersted in you should know your expectations for their role in your life.</i>)</font> </div>
								<div>
									<div style="float:left;">
							...
							<br/>
							<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left"><b>What is the ideal age range for your partner?<b></div>
								<div>
									<div style="float:left;">
								...
								<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>What is the race of your ideal partner?</b></div>
								<div style="float:left;">
								...
								<div style="width:430px;text-align:left;">
									<div style="width:230px;float:left">What is the ideal salary range for your partner?
									</div>
									<div>
										<div style="float:left;">
									...
									<div style="width:430px;text-align:left;">
										<div style="width:230px;float:left;"><b>What is the religion of your ideal partner?</b></div>
										<div style="float:left;">
											<div style="float:left;">
									...
									<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left"><b>Is it ok for your partner to have children?</b></div>
								<div>
									<div style="float:left;">
								...
								<div style="width:430px;text-align:left;">
									<div style="width:230px;float:left"><b>What is your ideal partners education level?</b></div>
									<div>
										<div style="float:left;">
								...
								<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left"><b>What amount of alcohol consumption is good for your ideal partner?</b></div>
								<div>
									<div style="float:left;">
								...
								<div style="width:430px;text-align:left;">
									<div style="width:230px;float:left"><b>What amount of drug use is good for your ideal partner?</b></div>
									<div>
										<div style="float:left;">
								...
								<div style="width:430px;text-align:left;">
								<div style="width:230px;float:left;"><b>What is the body type of your ideal partner?</b></div>
								<div style="float:left;">
								...
								<div style="width:430px;text-align:left;">
									<div style="width:230px;float:left"><b>Describe your ideal first date</b></div>
									<div>
										<div style="float:left;">
					...
					<div id="searchDiv" class="divDash_inv1">
						<div style="width:450px;height:400px;">
							...
							<div>
								...
								<div style="float:left;background-color:lime;width:390px;overflow:auto;overflow-x:hidden;border-left:solid 2px #000000;border-right:solid 2px #000000;">

									<div style="width:900px;position:relative;" id="row1">
							...
							<div style="padding:4px;border:solid 1px #000000;border-radius: 12px;background-color:gray;">
								<table>
									<tr>
										<td><img id="agape_profile_default_img_se" style="height:150px;" src="" border="1" /></td>
									
										<td valign="top" style="font-size:12px;font-family:arial;"><span>Username:</span></td>
										<td valign="top" width="110"><span style="font-size:12px;font-family:arial;color:blue;" id="agape_profile_username_se"></span></td>
										<td valign="top" style="font-size:12px;font-family:arial;"><span>Intentions:</span></td>
										<td valign="top"><div id="agape_profile_intentions_se" style="font-size:12px;font-family:arial;arial;color:blue;"></div></td>
									</tr>
									...
									<tr>
										...
										<td><div id="agape_profile_city_se" style="font-size:12px;font-family:arial;arial;color:blue;"></div></td>
										<td>State:</td>
										<td><div id="agape_profile_state_se"></div></td>
									</tr>
