...
class addAgape_vote_recordThumbs{

	static addVoteRecs(val){
		var tem = {}
		tem.job="updateComment";
		tem.dbase="agape_profile";
		tem.selectField="Agape_vote_recordThumbs";
		tem.param1="agape_profile_memberID";
		tem.selectParam="agape_profile_memberID";
		tem.issuesID=global.userObj.agape_profile_memberID;
		tem.username=global.userObj.agape_profile_username;
		tem.now=convertNowToPhP();
		tem.objR={};
		tem.objR.votetype="commentVote";
		tem.objR.mainId=val
		tem.strID=global.userObj.agape_profile_memberID;
		var funk=function(datum){
		}
		ajaxCallPost(tem,funk)
	}


	static checkThumbsB4list(){
